...
var regexNumberCard = /^1|^8|^9|^0/;
var createCard = function createCard() {
  var wrapper = (0, _redom.el)('div', {
    className: 'wrapper'
  });
  var card = (0, _redom.el)('div', {
    className: 'card'
  }, (0, _redom.el)('p', {
    className: 'secure'
  }, 'Secure Checkout'));
  var numberCardSpan = (0, _redom.el)('span', {
    className: 'card__number'
  }, 'xxxx xxxx xxxx xxxx');
  var nameCardSpan = (0, _redom.el)('span', {
    className: 'card__name'
  }, 'John Doe');
  var dateCardSpan = (0, _redom.el)('span', {
    className: 'card__date'
  }, '04/24');
  var nameDataWrapper = (0, _redom.el)('div', {
    className: 'card__personal'
  }, [nameCardSpan, dateCardSpan]);
  var frontCard = (0, _redom.el)('div', {
    className: 'credit-card'
  }, [numberCardSpan, nameDataWrapper]); //шапка карты с импутами вываода данных о владельце

  var nameCardInput = (0, _redom.el)('div', {
  ...
  var numberCardInput = (0, _redom.el)('div', {
  ...
  var dataCardInput = (0, _redom.el)('div', {
  ...
  var cvvCardInput = (0, _redom.el)('div', {
  ...
  //форма с инпутами
  var formWrapper = (0, _redom.el)('form', {
    className: 'form',
    id: 'form'
  }, [nameCardInput, numberCardInput, dataCardInput, cvvCardInput, (0, _redom.el)('button', {
    className: 'form__button'
  }, 'CHECK OUT')]);
  (0, _redom.setChildren)(card, frontCard, formWrapper);
  (0, _redom.setChildren)(wrapper, card);
  return wrapper;
};
(0, _redom.setChildren)(document.body, createCard());
},{"redom":"node_modules/redom/dist/redom.es.js"}],"../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
